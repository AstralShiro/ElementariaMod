...
namespace ElementariaMod.Content.Tiles.Decorations
{
	...
	public class AncestralRelicTile : ModTile
	{
		...
		public virtual string RelicTextureName => "ElementariaMod/Content/Tiles/Decorations/AncestralRelicTile";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "ElementariaMod/Content/Tiles/Decorations/AncestralRelicTilePedestal";
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			...
			switch (placeStyle) {
				case 0:
					itemType = ModContent.ItemType<Items.AncestralArtifact>();
					break;
