using ElementariaMod.Common.Systems;
...
namespace ElementariaMod.Content.Biomes
{
	// Shows setting up two basic biomes. For a more complicated example, please request.
	public class MenuSurfaceBiome : ModBiome
	{
		...
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("ElementariaMod/MenuSurfaceBackgroundStyle");
