...
{
	public class RareEarthCore : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Rare Earth Core");
			Tooltip.SetDefault("A powerful and bright rare elemental core, allows you to create Earth element weapons");
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<EarthGlobe>(), 50)
