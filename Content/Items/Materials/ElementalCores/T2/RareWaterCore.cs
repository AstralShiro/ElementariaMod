...
{
	public class RareWaterCore : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Rare Water Core");
			Tooltip.SetDefault("A powerful and bright rare elemental core, allows you to create Water element weapons");
		}
		...
		public override void AddRecipes()
		{
			CreateRecipe(1)
				...
				.AddIngredient(ModContent.ItemType<WaterGlobe>(), 50)
