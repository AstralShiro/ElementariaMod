...
namespace Elementaria.Items.Powders
{
    ...
    public class WaterPowder : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Use it for craft the Water Powder");
        }
		...
		recipe.AddIngredient(ModContent.ItemType<WaterStone>(), 5);
        recipe.AddTile(ModContent.TileType<MortarTile>());
		recipe.SetResult(this, 5);
		recipe.AddRecipe();
        
        new ModRecipe(mod);
		recipe.AddIngredient(ModContent.ItemType<WaterGlobe>(), 15);
        recipe.AddTile(ModContent.TileType<MortarTile>());
		recipe.SetResult(this, 5);
		recipe.AddRecipe();
		}
