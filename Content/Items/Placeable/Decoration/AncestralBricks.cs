...
using ElementariaMod.Content.Tiles.Decorations;

namespace ElementariaMod.Content.Items.Placeable.Decoration
{
	public class AncestralBricks : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Ancestral Bricks");
		...
		public override void SetDefaults() {
			...
			Item.createTile = ModContent.TileType<AncestralBricksTile>();
		}
		...
		public override void AddRecipes() {
			...
			CreateRecipe() // Add multiple recipes set to one Item.
				.AddIngredient<AncestralBricksItemWall>(4)
